...
enum ProfileExitAction { home, scan, history }
...
class ProfileScreen extends StatelessWidget {
              ...
              children: [
                _ProfileTopBar(
                  onBackTap:
                      () => Navigator.of(
                        context,
                      ).maybePop(ProfileExitAction.home),
                ),
  ...
  static Future<void> _openNotificationsFromProfile(
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            shape: BoxShape.circle,
                            border: Border.all(color: iconBackground, width: 2),
                          ),
                        ),
                      ),
                  ],
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Icon(icon, color: AppColors.primaryContainer, size: 34),
              ),
              const SizedBox(height: 18),
              Text(
                title,
...
class _ProfileFooter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Container(width: 54, height: 1, color: AppColors.border),
        const SizedBox(height: 18),
        Text(
